...
var id = 0;
var fields = {
  'open':['total','avgDisReq','medDisReq','maxDisReq','minDisReq','maxBidAmt','minBidAmt','avgBidAmt','medBidAmt'],
  'executed':['total','avgSave','highestSave','maxPrice','minPrice','medPrice','avgAmtSave','medAmtSave','avgPrice','medPrice','avgAmt','medAmt','avgDTE']
};
