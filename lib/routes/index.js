...
var routes = function (config) {
  ...
  //shadowbid: filters
  exp.generateOptions   = collectionRoute(config).generateOptions;
  exp.viewLineChart     = collectionRoute(config).viewLineChart;
  exp.renderLineChart   = collectionRoute(config).renderLineChart;
  exp.generateSums      = collectionRoute(config).generateSums;
