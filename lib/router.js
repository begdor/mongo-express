...
var router = function (config) {
  ...
  appRouter.get('/db/:database/exportCSV/:collection', mongoMiddleware, routes(config).exportCSV);
  appRouter.get('/db/:database/updateCollections', mongoMiddleware, routes(config).updateCollections);

  //shadowbid: filters
  appRouter.get('/db/:database/:collection/key',mongoMiddleware,routes(config).generateOptions);
  appRouter.get('/db/:database/:collection/getSums',mongoMiddleware,routes(config).generateSums);
  appRouter.get('/db/:database/:collection/line-chart',mongoMiddleware,routes(config).renderLineChart);
  // GridFS
